...
with sync_playwright() as p:
    ...
    for width, height, label in ((1440, 900, "desktop-1440x900"), (1280, 720, "desktop-1280x720"), (390, 844, "mobile-390x844"), (360, 800, "mobile-360x800")):
        ...
        page.get_by_role("heading", name="LEITSTAND").wait_for()
        ...
        page.get_by_role("button", name="Läufe").click()
        page.get_by_role("button", name="Übersicht").click()
        ...
        page.get_by_role("button", name="Übersicht").click()
        page.get_by_role("button", name="Anbieter").click()
